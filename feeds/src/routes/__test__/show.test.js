...
it('returns a 404 if the feed is not found', function () { return __awaiter(_this, void 0, void 0, function () {
    var id;
...
it('returns the feed if the feed is found', function () { return __awaiter(_this, void 0, void 0, function () {
    var title, price, response, feedResponse;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                title = 'concert';
